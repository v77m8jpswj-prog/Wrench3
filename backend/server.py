...
"""
    ...
    if specialty == "diesel":
        ...
        base += (
            ...
            "- ALWAYS wrap the table in a triple-backtick fenced code block (```...```) with cells\n"
            "  separated by TABS (\\t), not commas, not spaces. The frontend gives Doc a one-tap\n"
            "  COPY button on every fenced block — but ONLY if the cells are tab-separated.\n"
